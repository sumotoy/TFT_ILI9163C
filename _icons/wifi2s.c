...
* Icon/Image template version: 1.2
* Note: 
* ------------------------------------------------------------------------------
*******************************************************************************/
#if !defined(SUMO_ICN_LIB_wifi2s)
#define SUMO_ICN_LIB_wifi2s
...
static const tIcon wifi2s = { image_data_wifi2s, 29, 20, 580, 16, rle_enabled};
